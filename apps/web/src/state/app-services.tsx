...
export interface AppServices {
  ...
  noteTypeRegistry: NoteTypeRegistry<NoteTypeDescriptor>;
...
const defaultSettings: SettingsBodyProps = {
  ...
  appFontFamily: "",
  editorFontFamily: "__use_app__",
  fontFamilyOptions: [],
  onAppFontFamilyChange: noop,
  onEditorFontFamilyChange: noop,
  openInTab: false,
...
const AppServicesContext = createContext<AppServices>({
  ...
  fileHandlers: [],
  noteTypeRegistry: new NoteTypeRegistry<NoteTypeDescriptor>(),
